...
gulp.task('styles', function(){
    ...
    return gulp.src('./app/assets/styles/styles.css')
        .pipe(postcss([cssImport, cssvars, nested, autoprefixer])) /*This is where the transformation of the code automates - add in any gulp plugins here to apply the postcss*/
